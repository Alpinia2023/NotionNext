...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '闲心逸之', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个爱折腾开源项目和NAS的前端攻城狮', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.qazz.site/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 云舸轻舟', // 网站关键词 英文逗号隔开
